...
public class PDFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pdf = pintarPDF();
        my_webView.loadData(pdf,"text/html","UTF-8");
        /*
        File fichero = new File("C:\\Users\\usuario\\Downloads");
        try {
            FileReader lector = new FileReader(fichero);
            BufferedReader br = new BufferedReader(lector);
            String linea = br.readLine();
            while (linea != null) {
                my_webView.loadData(linea,"text/pdf","UTF-8");
                linea = br.readLine();
            }
            br.close();
    ...
    private String pintarPDF() {
        String html = "<h2>POLÍTICA DE PRIVACIDAD DE NET 4</h2>";
        html += "<p>El presente Política de Privacidad establece los términos en que NET 4 usa y protege la" +
                " información que es proporcionada por sus usuarios al momento de utilizar su sitio web." +
                "<br>Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos" +
                ...
                "<br>NET 4 está altamente comprometido para cumplir con el compromiso de mantener su información" +
                ...
                "<br>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su" +
                ...
                "<br>Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin su" +
                " consentimiento, salvo que sea requerido por un juez con un orden judicial." +
                " NET 4 Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en" +
                " cualquier momento.</p>";
        return html;
    }
}